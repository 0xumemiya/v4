    ...
    <DrawerContent className="px-6">
      ...
      <div className="flex px-4 flex-col space-y-4">
        ...
        <div>
          ...
          <div className="flex flex-col space-y-4">
          <DrawerClose onClick={() => router.push('https://github.com/0xumemiya')} className={'text-left font-light'}>
            <div className="flex items-center">
              <Github className="h-4 w-4" />
              <span className="ml-2">Github</span>
            </div> 
          </DrawerClose>
          <DrawerClose onClick={() => router.push('https://x.com/0xumemiya')} className={'text-left font-light '}>
            <div className="flex items-center">
              <div>
